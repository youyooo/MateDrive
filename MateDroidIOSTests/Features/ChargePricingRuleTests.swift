...
final class ChargePricingRuleTests: XCTestCase {
    ...
    func testCostSourceDisplayTextLocalizesDynamicValues() {
        ...
        XCTAssertEqual(ChargeCostSource.manual.displayText(language: .german), "Lokaler manueller Preis")
        XCTAssertEqual(ChargeCostSource.pricingRule.displayText(language: .spanish), "Regla de precios")
        XCTAssertEqual(ChargeCostSource.api.displayText(language: .italian), "Prezzo API TeslaMate")
        XCTAssertEqual(ChargeCostSource.none.displayText(language: .catalan), "No s'ha registrat cap cost")
    }
    ...
    func testChargeTypeDisplayTextLocalizesVisibleLabels() {
        ...
        XCTAssertEqual(ChargePricingChargeType.any.displayText(language: .german), "Beliebig")
        XCTAssertEqual(ChargePricingChargeType.teslaSupercharger.displayText(language: .spanish), "Supercargador Tesla")
        XCTAssertEqual(ChargePricingChargeType.otherDC.displayText(language: .italian), "Altri caricatori CC")
    ...
    func testChargerIdentityUsesTeslaBrandFromAnyRecordedSample() {
        ...
        XCTAssertEqual(ChargeStatsCalculator.chargerIdentity(detail), .teslaSupercharger)
    }
