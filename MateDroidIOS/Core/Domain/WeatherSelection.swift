...
public enum WeatherSelection {
    ...
    public static func calculateCumulativeDistances(
        ...
        let validPositions = positions.filter { $0.latitude != nil && $0.longitude != nil && $0.date != nil }
        ...
        for (index, position) in validPositions.enumerated() {
            ...
            result.append(WeatherPositionWithDistance(position: position, cumulativeDistanceKm: cumulativeDistance))
        }
