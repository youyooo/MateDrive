...
public enum RouteCoverage {
    public static let allReleaseRoutes: [AppRoute] = [
        .settings,
        .dashboard,
        .charges(carId: 1, exteriorColor: "PPSW"),
        .energyCycles(carId: 1, exteriorColor: "PPSW"),
        ...
        .activitySession(carId: 1, sessionId: "session-1"),
        .places(carId: 1),
        ...
        .driveMetricDetail(carId: 1, driveId: 3, metric: .energy, exteriorColor: "PPSW"),
        ...
        .costReview(carId: 1, exteriorColor: "PPSW"),
