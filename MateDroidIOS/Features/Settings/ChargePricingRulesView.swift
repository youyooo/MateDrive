...
public struct ChargePricingRulesView: View {
    ...
    public var body: some View {
        ...
        .sheet(item: $editingRule) { rule in
            NavigationStack {
                ChargePricingRuleEditorView(rule: rule) { updatedRule in
                    Task {
...
private struct ChargePricingRuleRow: View {
    ...
    private var summary: String {
        ...
        let location = rule.addressKeyword?.isEmpty == false ? rule.addressKeyword! : t("Any location", "任意位置")
...
private struct ChargePricingRuleEditorView: View {
    ...
    init(rule: ChargePricingRule, onSave: @escaping (ChargePricingRule) -> Void) {
