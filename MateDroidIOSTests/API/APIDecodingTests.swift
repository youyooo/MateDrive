...
final class APIDecodingTests: XCTestCase {
    ...
    func testCarsResponseDecodesAndroidNamePayload() throws {
        let data = """
        {
          "data": {
            "cars": [
    ...
    func testCarsResponseIgnoresLegacyAppNameWhenModelIdentityExists() throws {
        let data = """
        {
          "data": {
            "cars": [
        ...
        XCTAssertEqual(car?.displayName, "Model 3 Long Range")
        XCTAssertEqual(car?.vehicleModelName, "Model 3 Long Range")
    }
    ...
    func testChargeDetailResponseDecodesPointsAndNestedBatteryFields() throws {
        ...
        XCTAssertEqual(charge.map(ChargeStatsCalculator.chargerIdentity), .teslaSupercharger)
    }
    ...
    func testBatteryHealthAndUpdatesDecodeAndroidPayloads() throws {
        let batteryData = """
        {
          "data": {
            "battery_health": {
