...
public struct ChargePricingObservationService: ChargePricingObservationServicing {
    ...
    public func confirm(_ value: ChargePricingConfirmation) async throws {
        ...
        if let learnedRule {
            ...
            settings.chargePricingRules.append(learnedRule)
            await settingsStore.save(settings)
        }
    }

    private static func validate(_ value: ChargePricingConfirmation) throws {
